...
||2|<li>功能类-引用内容自动翻译<li>功能类-文献自动翻译|
...
|X(推特)|11|<li>分段广告-主页信息流广告<li>分段广告-帖子详情页、搜索页信息流广告<li>分段广告-用户资料页信息流广告<li>评价提示<li>权限提示-通知权限<li>功能类-自动点击翻译<li>功能类-自动点击[显示更多帖子]<li>其他-关闭[开启个性化广告]弹窗<li>功能类-自动显示可能的垃圾信息<li>功能类-[保存]图片帖子<li>功能类-网络错误自动重试|
|ZK助手|1|<li>全屏广告-弹窗广告|
