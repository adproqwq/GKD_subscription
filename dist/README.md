...
|YouTube|12|<li>全屏广告-视频播放-跳过广告<li>全屏广告-视频播放-赞助商广告<li>全屏广告-会员广告<li>权限提示-通知权限<li>功能类-自动翻译评论<li>其他-关闭播放器无障碍辅助弹窗<li>功能类-关闭视频播放结束后的推荐视频<li>局部广告<li>分段广告-播放页广告<li>功能类-自动展开更多回复<li>功能类-跳过视频内容警告<li>功能类-退出自动关闭小窗|
