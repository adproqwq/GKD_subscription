...
[![Release](https://img.shields.io/badge/发行版-v501-blue)](https://github.com/Lin-arm/GKD_subscription/releases/latest)
[![已适配应用](https://img.shields.io/badge/已适配应用-943-brightgreen)](./dist/README.md#应用规则)
[![全局规则组](https://img.shields.io/badge/全局规则组-3-blueviolet)](./dist/README.md#全局规则)
[![应用规则组](https://img.shields.io/badge/应用规则组-2280-orange)](./dist/README.md#应用规则)
...
<!-- > 当前版本: v501
> 
> 当前订阅文件已适配 943 个应用，共有 2280 应用规则组，3 全局规则组
> 
...
![img](https://contrib.rocks/image?repo=Lin-arm/GKD_subscription&max=200&_v=501)
