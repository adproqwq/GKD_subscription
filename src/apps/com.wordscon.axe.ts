...
export default defineGkdApp({
  ...
  groups: [
    ...
    },
    {
      ...
      rules: [
        ...
        },
        {
          ...
          snapshotUrls: 'https://i.gkd.li/i/28225930',
    ...
    },
    {
      ...
      fastQuery: true,
      activityIds: '.topic.AXDetailTopicActivity', //热门话题页
      rules: [
        {
          key: 1,
          name: '①点击x掉',
          ...
          snapshotUrls: 'https://i.gkd.li/i/28226759', // 防误右下角触悬浮按键: [bottom<getPrev(3).top]
        ...
        },
        {
          ...
          name: '②点击[不感兴趣]',
          matches: '@[clickable=true] >2 [text="不感兴趣"]',
          snapshotUrls: 'https://i.gkd.li/i/28226757',
        },
        {
          key: 3,
          preKeys: [2],
